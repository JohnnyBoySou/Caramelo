...
export default function DonateSuccessScreen({ navigation, route }) {
        ...
        <Main style={{ backgroundColor: "#fff", }}>
            <Scroll>
                ...
                <Column style={{ justifyContent: 'center', alignItems: 'center', marginVertical: 20, }}>
                    <ButtonPrimary label='Nova doação' onPress={() => { navigation.navigate('DonateValue') }} style={{ paddingHorizontal: 24, borderColor: color.primary, }} />
                    <Column style={{ height: 20, }} />
                    <ButtonPrimary type='sc' label='Ver minhas doações' onPress={() => { navigation.navigate('History') }} style={{ paddingHorizontal: 24, borderColor: color.secundary, }} />
                </Column>
            </Scroll>
